...
namespace DDDD
{
    class SpriteAnimatedNest
    {
        ...
        public SpriteAnimatedNest(Texture2D texture, Vector2 vector2)
        {
            _texture = texture;
            _position = vector2;
            foodFromDaddy = 0;
            ...
            aniFrame = 0;
            frame = 0;
            babyRec = new Rectangle((int)_position.X, (int)_position.Y, _texture.Width, _texture.Height);
        }
        /*
