    ...
    public class Main : Game
    {
        ...
        private void reload() //reset game values when win or fail
        {
            ...
            */
            ...
            nests.Add(new SpriteAnimatedNest(nest1Texture, new Vector2(0, 1080 / 2 + 42)));
            nests[0].babyRec.Width = nests[0].babyRec.Width / 37;

            nest2Texture = Content.Load<Texture2D>("DinoBabyEggLoopAnimationB");
            nests.Add(new SpriteAnimatedNest(nest2Texture, new Vector2(1775, 1080 / 2 + 42)));
            nests[1].babyRec.Width = nests[1].babyRec.Width / 43;

            nest3Texture = Content.Load<Texture2D>("DinoBabyEggLoopAnimationC");
            nests.Add(new SpriteAnimatedNest(nest3Texture, new Vector2(888, 1080 / 2 + 272)));
            nests[2].babyRec.Width = nests[1].babyRec.Width / 49;
                    ...
                    case GameState.Playing:
                        ...
                        else
                        {
                            ...
                            for (int i = 0; i < meteors.Count; i++)
                            {
                                ...
                                {
                                    if (nests[j].babyRec.Intersects(meteors[i].Rectangle) && nests[j].grown == false)
                                    {
                                    ...
                                    if (nests[i].foodFromDaddy < foodMax && deadBaby.babyDying == false) //stops receving when reaching Max
                                    {
                                        ...
                                        if (nests[i].foodFromDaddy == 1)
                                        {
                                            if (dino.dinoPosition.X > nests[i]._position.X)
                                            {
                                                ...
                                                nests[i].frame = 49;
                                                nests[i].babyRec.Width = nests[i].Rectangle.Width / 50;
                                        ...
                                        else if (nests[i].foodFromDaddy == 2)
                                        {
                                            if (dino.dinoPosition.X > nests[i]._position.X)
                                            {
                                                ...
                                                nests[i].frame = 67;
                                                nests[i].babyRec.Width = nests[i].Rectangle.Width / 68;
                                            }
                                            else
                                            {
                                        ...
                                        else if (nests[i].foodFromDaddy == 3)
                                        {
                                            if (dino.dinoPosition.X > nests[i]._position.X)
                                            {
                                                ...
                                                nests[i].frame = 79;
                                                nests[i].babyRec.Width = nests[i].Rectangle.Width / 80;
                                            }
                                            else
                                            {
                                        ...
                                        else if (nests[i].foodFromDaddy == 4)
                                        {
                                            if (dino.dinoPosition.X > nests[i]._position.X)
                                            {
                                                ...
                                                nests[i].frame = 73;
                                                nests[i].babyRec.Width = nests[i].Rectangle.Width / 74;
                                            }
                                            else
                                            {
                                        ...
                                        else if (nests[i].foodFromDaddy == 5)
                                        {
                                            if (dino.dinoPosition.X > nests[i]._position.X)
                                            {
                                                ...
                                                chomps[i].frame = 5;
                                                nests[i]._texture = Content.Load<Texture2D>("waiting5");
                                                nests[i].frame = 50;
                                                nests[i].babyRec.Width = nests[i].Rectangle.Width / 51;
                                            }
                                            else
                                            {
        ...
        */
        ...
        private void babyIsFed()
        {
            for (int i = 0; i < foods.Count; i++)
            {
                ...
                for (int j = 0; j < nests.Count; j++)
                {
                    if (nests[j].babyRec.Intersects(foodRectangle) && foods[i].foodHit)
                    {
